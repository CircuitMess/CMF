...
/**
 * @brief Empty singleton class used to ensure all singletons will be objects. Singletons are stored in the Application instance and exactly one of each type can exist at all times within the application.
 */
